...
class GraphSetup:
    ...
    def setup_graph(
        ...
        analyst_factories = {
            ...
            "fundamentals": lambda: create_fundamentals_analyst(self.mid_thinking_llm),
        }
        ...
        neutral_analyst = create_neutral_debator(self.mid_thinking_llm)
        conservative_analyst = create_conservative_debator(self.mid_thinking_llm)
